...
namespace BloodBankManagementSystem
{
    public partial class frmHome : Form
    {
        ...
        private void lblApositiveCount_Click(object sender, EventArgs e)
        {

        }

        private void lblApositive_Click(object sender, EventArgs e)
        {

        }

        private void lblAnegative_Click(object sender, EventArgs e)
        {
        ...
        private void lblABnegativeCount_Click(object sender, EventArgs e)
        {
